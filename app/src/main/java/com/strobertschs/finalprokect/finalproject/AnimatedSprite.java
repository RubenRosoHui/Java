...
public abstract class AnimatedSprite extends Sprite {
    ...
    private int horizontal_amount;  // how much the water moves along the horizontal axis
    private int up_amount;          // how much the water moves downward
    private int down_amount;        // how much the water moves upward
    ...
    /**
     * moveUp: indicate the water to move up
     */
    public void moveUp(){
        movingUp = true;
        movingDown = false;
    ...
    /**
     * moveDown: indicate the water to move down
     */
